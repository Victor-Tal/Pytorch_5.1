...
batch_size = número de muestras de entrenamiento utilizadas en un pase hacia adelante/hacia atrás
número de iteraciones = número de pases, cada pase (hacia adelante + hacia atrás) utiliza [batch_size] número de muestras
ej: 100 muestras, batch_size=20 -> 100/20=5 iteraciones para 1 epoch
